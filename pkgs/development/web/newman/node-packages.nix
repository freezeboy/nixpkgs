...
let
  sources = {
    ...
    "eslint-plugin-lodash-7.2.0" = {
      ...
      version = "7.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/eslint-plugin-lodash/-/eslint-plugin-lodash-7.2.0.tgz";
        sha512 = "7Wf7SOCK90OFgPd8LleVQa8uCWBZDLjPKxaFdwM/aINDyXhley0nRKSKL6TESGFCCMduYPox5VLttvqV2Vfbig==";
      };
    };
    "eslint-plugin-mocha-8.1.0" = {
      ...
      version = "8.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/eslint-plugin-mocha/-/eslint-plugin-mocha-8.1.0.tgz";
        sha512 = "1EgHvXKRl7W3mq3sntZAi5T24agRMyiTPL4bSXe+B4GksYOjAPEWYx+J3eJg4It1l2NMNZJtk0gQyQ6mfiPhQg==";
      };
    };
...
in
{
  newman = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."eslint-plugin-lodash-7.2.0"
      sources."eslint-plugin-mocha-8.1.0"
